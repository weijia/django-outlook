...
class MessageWithProxy(object):
    ...
    def __init__(self, json=None, connection=None, verify=True):
        '''
    ...
    def moveToFolder(self, folder_id):
        ...
        """
        # move_url = 'https://outlook.office.com/api/v2.0/me/messages/{0}/move'
        move_url = 'https://graph.microsoft.com/v1.0/me/messages/{0}/move'
        # move_url = 'https://graph.microsoft.com/beta/me/messages/{0}/move'
        # move_url = 'https://outlook.office365.com/api/v1.0/me/messages/{0}/move'
        headers = {'Content-type': 'application/json',
                   'Accept': 'application/json'}
        post_data = {"DestinationId": folder_id}
        try:
            mail_id = self.json['id']
            move_mail_url = move_url.format(mail_id)
            response = self.connection.post_common_response(move_mail_url,
                                                            json=post_data,
                                                            headers=headers,
                                                            verify=self.verify,
                                                            )
